...
function SettingsPage({ settings, setSettings }) {
  ...
  const resetSettings = () => {
    ...
    document.body.classList.remove("smartstock-compact-mode");
    setSaved(false);
  };
    ...
    <section className="settings-page">
      <div className="settings-page-header">
        <div>
          ...
          <p>
            Configure your profile, alerts, AI behavior and inventory
            preferences.
          </p>
        </div>
      ...
      <div className="settings-grid">
        <article className="settings-panel">
          <div className="settings-panel-title">
            ...
            <div>
              <h3>Profile</h3>
              <p>Information displayed across your workspace.</p>
            </div>
          </div>
        ...
        <article className="settings-panel">
          <div className="settings-panel-title">
            ...
            <div>
              ...
              <p>Control layout density and dashboard behavior.</p>
            </div>
          </div>
        ...
        <article className="settings-panel">
          <div className="settings-panel-title">
            ...
            <div>
              <h3>Notifications</h3>
              <p>Choose which business events should notify you.</p>
            </div>
          </div>

          <SettingToggle
            checked={draft.stockAlerts}
            onChange={(value) => updateField("stockAlerts", value)}
          ...
          <SettingToggle
            ...
            onChange={(value) => updateField("forecastAlerts", value)}
        ...
        <article className="settings-panel">
          <div className="settings-panel-title">
            ...
            <div>
              <h3>AI Copilot</h3>
              <p>Configure how SmartStock AI assists you.</p>
            </div>
          </div>

          <SettingToggle
            checked={draft.aiSuggestions}
            onChange={(value) => updateField("aiSuggestions", value)}
        ...
        <article className="settings-panel settings-panel-wide">
          <div className="settings-panel-title">
            ...
            <div>
              ...
              <p>Configure thresholds used by your inventory engine.</p>
            </div>
          </div>
      ...
      <div className="settings-danger-zone">
        <div>
          ...
          <p>
            Restore all SmartStock settings to their default values.
          </p>
        </div>
